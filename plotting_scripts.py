...
###################################################
# Function to plot a bar plot of flux vs velocity #
#   Parameters:                                   #
#       fluxbin: 1D list of fluxes                #
#       velbin: 1D list of velocities at          #
#           locations of fluxbin                  #
###################################################
...
##################################################
# Function to plot a PVD with flux/velocity maps #
#   Parameters:                                  #
#       fluxbin: 1D list of fluxes               #
#       velbin: 1D list of velocities at         #
#           locations of fluxbin                 #
#       xbin: 1D list of x locations for velbin  #
#           and fluxbin                          #
#       ybin: same as xbin but for y locations   #
##################################################
